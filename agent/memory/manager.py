...
class MemoryManager:
    ...
    def finish_task(self, state: TaskState, note: str = "") -> dict[str, Any]:
    ...
    def _summarize(self, state: TaskState) -> dict[str, Any]:
        ...
        try:
            ответ = self.client.call(self.summarizer_model, сообщения,
    ...
    def stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            LONG: {
                "профиль": долго["стиль"] + долго["ограничения"],
